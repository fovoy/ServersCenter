...
public class Numbers {
    ...
    public static void main(String[] strs) {
        ...
        System.out.println(ipToLong2("10.24.50.1") == ipToLong("10.24.50.1"));;

        nano = System.nanoTime();
        for(int i=0;i<1000000;i++)
            ipToLong("101.224.150.13");

        long time1 = System.nanoTime() - nano;

        nano = System.nanoTime();
        for(int i=0;i<1000000;i++)
            ipToLong2("101.224.150.13");

        long time2 = System.nanoTime() - nano;
